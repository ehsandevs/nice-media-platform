...
class VideoCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('disk');
        CRUD::column('path');
        CRUD::column('converted_for_downloading_at');
        CRUD::column('converted_for_streaming_at');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('title');
        CRUD::field('original_name');
        CRUD::field('disk');
        CRUD::field('path');
        CRUD::field('converted_for_downloading_at');
        CRUD::field('converted_for_streaming_at');
